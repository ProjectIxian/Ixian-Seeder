...
#pragma warning restore CA1416 // Validate platform compatibility
        ...
        static void onStart(string[] args)
        {
            ...
            Console.WriteLine(string.Format("IXIAN Seeder {0} ({1})", Config.version, CoreConfig.version));
            Console.ResetColor();
            ...
            Logging.info("Starting IXIAN Seeder {0} ({1})", Config.version, CoreConfig.version);
            ...
            if (ConsoleHelpers.verboseConsoleOutput)
                Console.WriteLine("-----------\nPress Ctrl-C or use the /shutdown API to stop the Seeder process at any time.\n");
        }
        ...
        static void onStop()
        {
            ...
            {
                Console.WriteLine("");
                Console.WriteLine("Ixian Seeder Node stopped.");
            }
        }
    }
}

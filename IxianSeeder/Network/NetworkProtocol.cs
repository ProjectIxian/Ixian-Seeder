            ...
            try
            {
                switch (code)
                {
                    case ProtocolMessageCode.hello:
                        ...
                        // Send random presences immediately after hello
                        handleGetRandomPresences('M', endpoint);
                        handleGetRandomPresences('H', endpoint);
                        break;
                    ...
                    case ProtocolMessageCode.getRandomPresences:
                        ...
                        // TODO improve disconnecting the clients; should be disconnected after hello->getRandomPresences()
                        CoreProtocolMessage.sendBye(endpoint, ProtocolByeCode.bye, "Disconnected after sending presences.", "", true);
                        break;
